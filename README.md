# `LibUCL_jll.jl` (v0.9.2+0)

[![deps](https://juliahub.com/docs/LibUCL_jll/deps.svg)](https://juliahub.com/ui/Packages/General/LibUCL_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/4b016d5110f74a136346d567c0fce21818dc6628/L/LibUCL/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/vstakhov/libucl.git (revision: `16498fcfb0148963feecf0401dc6d2d5089cebdf`)
